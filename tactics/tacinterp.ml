...
let intern_red_expr ist = function
  ...
  | CbvNbe o -> CbvNbe (Option.map (intern_typed_pattern_with_occurrences ist) o)
...
let interp_red_expr ist sigma env = function
  ...
  | CbvNbe o ->
    sigma , CbvNbe (Option.map (interp_closed_typed_pattern_with_occurrences ist env sigma) o)
...
let subst_redexp subst = function
  ...
  | CbvNbe o -> CbvNbe (Option.map (subst_pattern_with_occurrences subst) o)
  | (Red _ | Hnf | ExtraRedExpr _ as r) -> r
