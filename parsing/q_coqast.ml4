...
let mlexpr_of_red_expr = function
  ...
  | Glob_term.CbvNbe o -> <:expr< Glob_term.CbvNbe $mlexpr_of_option mlexpr_of_occ_constr o$ >>
...
let rec mlexpr_of_atomic_tactic = function
  ...
  | Tacexpr.TacNativeCastNoCheck c ->
      <:expr< Tacexpr.NativeCastNoCheck $mlexpr_of_constr c$ >>
